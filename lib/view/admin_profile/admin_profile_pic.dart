...
//!admin profile picture page
class AdminProfilePicture extends StatefulWidget {
  const AdminProfilePicture({super.key});

  @override
  State<AdminProfilePicture> createState() => _AdminProfilePictureState();
}

class _AdminProfilePictureState extends State<AdminProfilePicture> {
  //*Admin choose img from gallery or photo
